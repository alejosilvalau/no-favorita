    ...
    if ($vResult) {
      ...
      if (pg_query($link, $insert_qry)) {
        ...
        try {
          ...
          $mail->Body = "Haz clic en el siguiente enlace para confirmar tu registro: <a href='http://localhost/no-favorita/public/confirmar.php?token=$token'>Confirmar Registro</a>";
